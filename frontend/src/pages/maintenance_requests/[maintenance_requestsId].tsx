...
const EditMaintenance_requests = () => {
  ...
  const { maintenance_requestsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: maintenance_requestsId }));
  }, [maintenance_requestsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: maintenance_requestsId, data }));
...
EditMaintenance_requests.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditMaintenance_requests;
